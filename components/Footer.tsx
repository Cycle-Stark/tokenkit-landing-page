...
export default function Footer() {
  ...
  const onSubmit = async (data: { email: any }) => {
    try {
      ...
      if (response.ok) {
        ...
        toaster("success", "Subscription successful");
      } else {
        console.error("Subscription failed");
        toaster("success", "Subscription failed");
      }
    } catch (error) {
  ...
  return (
    <footer className="bg-[#030014]" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto pb-8 pt-20 sm:pt-24 lg:pt-32 px-3 md:px-24 ">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; 2024 TokenKit, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
