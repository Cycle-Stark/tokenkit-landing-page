...
const SEOHeader = (props: SEOHeaderProps) => {
    ...
    return (
        <Head>
            ...
            <meta property="og:image" content={image ?? `${APP_URL}/static/images/tokenkit-banner.png`} />
            ...
            <meta property="twitter:image" content={image ?? `${APP_URL}/static/images/tokenkit-banner.png`} />
